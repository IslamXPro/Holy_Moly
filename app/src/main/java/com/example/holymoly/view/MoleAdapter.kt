package com.example.holymoly.view
...
import com.example.holymoly.view.MoleHolder
...
class MoleAdapter (var model: MoleModel) : BaseAdapter () {
     ...
     * If the type is null, return R.drawable.gress
     */
    fun getDrawable (type: MoleType?): Int {
        ...
        when (type) {
            ...
            // Default to GRASS (R.drawable.gress) if nothing else fits.
            // Gas, gress or ass, no one rides for free.
            else ->
